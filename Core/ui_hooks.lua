return function(FT)
    ...
    local misprint = FT.load_module('Core/misprint_compat.lua')(FT)
    ...
    Card.generate_UIBox_ability_table = function(self, ...)
        misprint.patch_jokerdisplay_misprint_definition()
        local vars_only = ...
        ...
        if misprint.apply_misprint_vanilla_override(
                self,
                U.resolve_effective_joker_card(self),
                ui_table,
                descriptors,
